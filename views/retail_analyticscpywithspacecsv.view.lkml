# The name of this view in Looker is "Retail Analyticscpywithspacecsv"
view: retail_analyticscpywithspacecsv {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: ui_test.RetailAnalyticscpywithspacecsv ;;
  ...
  dimension: orders_market {
    type: string
    sql: ${TABLE}.`Orders Market` ;;
  }

  dimension: orders_region {
    type: string
    sql: ${TABLE}.`Orders Region` ;;
  }

  dimension: people_region {
    type: string
    sql: ${TABLE}.`People Region` ;;
  }
